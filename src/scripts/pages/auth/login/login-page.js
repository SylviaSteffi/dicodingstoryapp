          ...
          <form id="login-form" class="login-form" aria-labelledby="login-title">
            <div class="form-control">
              ...
              <div class="login-form__title-container">
                <input id="email-input" type="email" name="email" aria-required="true" placeholder="Contoh: nama@email.com">
              </div>
            </div>
            <div class="form-control">
              ...
              <div class="login-form__title-container">
                <input id="password-input" type="password" name="password" aria-required="true" placeholder="Masukkan password Anda">
              </div>
            </div>
