    ...
    return `
      <section class="register-container">
        <div class="register-form-container">
          ...
          <form id="register-form" class="register-form" aria-labelledby="register-title">
            <div class="form-control">
              <label for="name-input" class="register-form__name-title">Nama lengkap</label>

              <div class="register-form__title-container">
                <input id="name-input" type="text" name="name" aria-required="true" placeholder="Masukkan nama lengkap Anda" required>
              </div>
            </div>
            <div class="form-control">
              ...
              <div class="register-form__title-container">
                <input id="email-input" type="email" name="email" aria-required="true" placeholder="Contoh: nama@email.com" required>
              </div>
            </div>
            <div class="form-control">
              ...
              <div class="register-form__title-container">
                <input id="password-input" type="password" name="password" aria-required="true" placeholder="Masukkan password baru" required>
              </div>
            </div>
